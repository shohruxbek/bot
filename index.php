<?php
define('BOT_TOKEN', '777301905:AAGkp3z8ha0sHBoLNwB44rrFCOvkmD4aA8s');
// manba @xvest kanalidan kochirildi
...
apiRequestJson("sendMessage", array('chat_id' => $chat_id, "text" => "🔹Bu bot yordamida dunyoga mashxur bo'lgan ❌ ⭕️ o'yinini o'ynashiz mumkin.", 'reply_markup' => array(
"inline_keyboard"=>array(
array(array("text"=>"InSoft","url"=>"https://telegram.me/intellectSoftUz"),
array("text"=>"MushukBot","url"=>"https://telegram.me/MushukBot")),
array(array("text"=>"O'yinni boshlash","switch_inline_query"=>md5(date("YMDms"))))
)
)));
}
}
...
$query=$inline['query'];
apiRequest("answerInlineQuery",array("inline_query_id"=>$id,"results"=>array(array("type"=>"article","id"=>$query,"title"=>"X 0 o'yini","input_message_content"=>array("message_text"=>"<b>X-O </b>O'ynash uchun startni bosing","parse_mode"=>"HTML","disable_web_page_preview"=>false),
"reply_markup"=>array(
"inline_keyboard"=>array(
array(array("text"=>"START","callback_data"=>"play_".$chat_id))
)
)
))));
exit;
...
apiRequest("editMessageText",array("inline_message_id"=>$message_id,"text"=>"O'yinTugadi.","reply_markup"=>array(
"inline_keyboard"=>$Tab
)));
exit;
}
...
define('WEBHOOK_URL', 'https://sayt.000webhostapp.com/xo.php');
